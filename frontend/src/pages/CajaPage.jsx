...
import { Lock, Unlock, DollarSign, ArrowUpRight, Plus, Activity } from 'lucide-react';
      ...
      {!caja ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <StatCard title="Ingresos por Ventas" value={caja.ingresosVentas} icon={<ArrowUpRight size={24} />} color="bg-emerald-100 text-emerald-600" />
